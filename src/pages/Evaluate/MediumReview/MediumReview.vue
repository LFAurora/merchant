<template>
  <section class="medium_reputation">
...
<style>
  ...
  .evaluate_shop_msg>span{
    display: block;
  }
  .evaluate_shop_msg>span:nth-child(2){
    margin-top: 2vh;
    color: #f5141b;
  }
  .evaluate_btn{
  ...
  .evaluate_btn>button:nth-child(1){
    height: 4vh;
    width: 15vw;
    font-size: 15px;
    color: #232323;
  ...
  .evaluate_btn>button:nth-child(2){
    height: 4vh;
    width: 25vw;
    color: #232323;
    font-size: 15px;
